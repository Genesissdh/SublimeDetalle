                        ...
                        <div class="product__details__text">
                            ...
                            <div class="product__details__price">$ 400.0 <span>$ 450.0</span></div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="color__checkbox">
                                                <label for="white">
                                                    <input type="radio" name="color__radio" id="white" required="">
                                                    <span class="checkmark white-bg"></span>
                                                </label>
                                                <label for="yellow">
                                                    <input type="radio" name="color__radio" id="yellow" required="">
                                ...
                                <div class="product__details__button">
                                    ...
                                    <a href="#" class="cart-btn" type="submit"><span  class="icon_bag_alt"></span> Añadir al carrito</a>
                                </div>
                            </div>                            
                        </div>
                    </div>
