            ...
            <div class="card-body">
                ...
                <input type="hidden" name="id" id= "id" value="<?php echo $row['codmantenimiento']; ?> ">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fecha" name="fecha" aria-describedby="fechaAyuda" required="" value="<?php echo $row['fecha'] ?>">
                        <small id="fechaAyuda" class="form-text text-muted">Este campo es obligatorio</small> 
                    </div>
                    
                    <div class="form-group">
                        <label for="costo">Costo*</label>
                        <input type="number" class="form-control" id="costo" name="costo" aria-describedby="costoAyuda" min="0" value="<?php echo $row['valor_mantenimiento']; ?>">
                        <small id="costoAyuda" class="form-text text-muted">Este campo es obligatorio</small>
                    </div>
                    
                    <div class="form-group">
                        <label for="Nombre">Descripcion*</label>
                        <textarea rows="4" class="form-control" name="descripcion" id="descripcion" placeholder="Comentarios del Mantenimiento"><?php echo $row['descripcion']; ?></textarea>                        
                    </div>
                    <input type="submit" class="btn btn-success btn-lg btn-block" value="Guardar" name="guardar">
                    <a href="./mantenimiento_mant.php" class="btn btn-secondary  btn-lg btn-block "> Cancelar </a>
                </form>
            </div>
        </div>
        </div>
